#include "../../../../include/httpserver/utils/db/DbConnectionPool.h"
#include "../../../../include/httpserver/utils/db/DbException.h"
                          ...
                          size_t poolSize) 
{
    ...
    initialized_ = true;
    LOG_INFO ("Database connection pool initialized with %lu  connections",poolSize);
}
